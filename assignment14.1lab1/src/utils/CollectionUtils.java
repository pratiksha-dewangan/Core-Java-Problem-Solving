...
public class CollectionUtils {
	...
	public static HashSet<Library> populateData() {
		...
		try{
			library.add(new Library("Touch of Eternity",DRAMA,500,convertDate("1-12-2020"),"Durjoy Dutta",12));
			library.add(new Library("War and Peace",FICTION,500,convertDate("1-1-2012"),"Leo Tolstoy",20));
			library.add(new Library("World's best boyfriend",FICTION,500,convertDate("1-1-2015"),"Durjoy Dutta",23));
			library.add(new Library("Oh yes! I am Single",FICTION,500,convertDate("1-1-2021"),"Durjoy Dutta",42));
